...
`1.1.4` setpoint-mode fix, the `1.1.3` thermostat sensor fix for stale raw
Nest mode values, and the `1.1.2` thermostat display fix for cooling/heating
modes where the Nest API omits the active target temperature.
